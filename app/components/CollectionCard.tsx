...
export function CollectionCard({ title, overview, itemCount, readTime, image, href }: CollectionCardProps) {
  return (
    <Link href={href} className="glass-panel overflow-hidden group block hover:shadow-float-high hover:-translate-y-[4px] transition-all duration-500 ease-out">
      <div className="w-full h-[200px] overflow-hidden relative">
        <div className="absolute top-[16px] left-[16px] bg-background/80 backdrop-blur-md px-[12px] py-[4px] rounded-full flex items-center gap-[6px] border border-outline/50 z-10">
          <div className="w-[4px] h-[4px] rounded-full bg-bronze-accent" />
          <span className="font-meta text-[10px] tracking-[0.1em] uppercase text-text-secondary">
